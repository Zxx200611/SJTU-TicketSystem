...
public:
    ...
    inline static Train zero();
    inline static Train positiveInfinity();
};
class TrainCompareByIdAndStationNum
{
public:
...
BPlusTree<Train,TrainCompareByIdAndStationNum,10,12> Trains("Trains.dat");
BPlusTree<StationTimeTrain,STTCompareByStationAndTime,30,512> Arriv("Arriv.dat"),Depar("Depar.dat");
