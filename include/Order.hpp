...
public:
    ...
    inline static Order zero();
    inline static Order positiveInfinity();
};
class OrderCompareByUsernameAndTag
{
public:
...
public:
    ...
    inline static SemiOrder zero();
    inline static SemiOrder positiveInfinity();
};
class SOCompareByTrainidAndDeparDate
{
public:
