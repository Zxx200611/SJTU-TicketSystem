...
bool TrainCompareByIdAndStationNum::operator () (const Train &a,const Train &b)
{
    int res=strcmp(a.train_id,b.train_id);
    if(res==0) return a.station_num<b.station_num;
    return res<0;
}
// Train******************************************************************************
...
StationTimeTrain StationTimeTrain::zero(){return StationTimeTrain();}
StationTimeTrain StationTimeTrain::positiveInfinity(){return StationTimeTrain("~~~~~~~~~~~~~~~~~~~~",0,0,"",0,0,0,0,0);}

bool STTCompareByStationAndTime::operator () (const StationTimeTrain &a,const StationTimeTrain &b)
{
    if(strcmp(a.station,std::string("~~~~~~~~~~~~~~~~~~~~").c_str())==0) return 0; 
    if(strcmp(b.station,std::string("~~~~~~~~~~~~~~~~~~~~").c_str())==0) return 1; 
    int res=strcmp(a.station,b.station);
...
{
    // std::cout<<"Releasing "<<_train_id<<std::endl;
    sjtu::vector<Train> tmp=Trains.find
    (
        Train(_train_id,0,0,"","",0,"","","",0),
        Train(_train_id,Train::max_station_cnt+1,0,"","",0,"","","",0)
